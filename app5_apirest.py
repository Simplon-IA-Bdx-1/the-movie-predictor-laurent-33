...
parser.add_argument('context', choices=['people', 'movies', 'import'], help='La table concernée, people ou movies')
...
$ python app.py movies import --api omdb --imdbid tt7016254
$ python app.py movies import --api themoviedb --imdbid
"""
